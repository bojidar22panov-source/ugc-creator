...
const navItems: NavItem[] = [
    { to: '/', icon: <LayoutDashboard className="w-5 h-5" />, label: 'Начало' },
    { to: '/create', icon: <Sparkles className="w-5 h-5" />, label: 'Създай видео' },
    { to: '/library', icon: <Library className="w-5 h-5" />, label: 'Моите видеа' },
    { to: '/projects', icon: <FolderOpen className="w-5 h-5" />, label: 'Проекти' },
